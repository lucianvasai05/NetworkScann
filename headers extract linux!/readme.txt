-->Programul ofera posibilitatea de vizualizare a header-elor interceptate pe un anumit device disponibil  ce poate fi selectat de
catre utilizator
...
-->functia process_packet = contorizeaza toate pachetele si le distribuie in functie de protocoale
